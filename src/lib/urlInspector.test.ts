...
describe('inspectUrl', () => {
  ...
  it('creates fallback synthetic hop when inline HTML parsing fails and resolver is disabled', async () => {
    let callCount = 0
